...
- [用户指南](user-guide/getting-started.md) - 用户使用手册
- [开发环境搭建](development/deployment/development.md) - 本地开发环境配置
...
- [快速开始](user-guide/getting-started.md) - 5分钟快速上手
...
- **新用户**: 建议从 [快速开始](user-guide/getting-started.md) 开始
- **开发者**: 查看 [开发文档](development/) 和 [API 文档](development/api/)
- **产品经理**: 参考 [产品文档](product/) 和 [设计文档](design/)
- **测试人员**: 查看 [测试文档](testing/)
